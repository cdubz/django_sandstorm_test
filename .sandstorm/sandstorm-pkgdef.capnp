...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "j4z01cprch2znhwmu9gwtw7t55kxy3hhn7rt87ccmqc55qun8yd0",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Django Sandstorm Test App"),
  ...
  alwaysInclude = [ "opt/app", "usr/lib/python3", "usr/lib/python3.7" ],
